...
describe("Util", function () {
    ...
    describe("resolveKeyPath", () => {
        ...
        it("should return value at specified keyPath", function () {
            expect(util.getValueAtKeyPath("name.last", obj)).toEqual(obj.name.last);
        })
        it("should return undefined if nothing exists at keyPath", function () {
            expect(util.getValueAtKeyPath("does.not.exist", obj)).toBeUndefined();
        })
        it("should return undefined if obj is undefined", function () {
            var undefinedObject;
            expect(util.getValueAtKeyPath("should.not.work", undefinedObject)).toBeUndefined();
        })
