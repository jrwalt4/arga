...
},{"./adapter/CommandBuilderBase":23,"./core/DataColumn":25,"./core/DataColumnCollection":26,"./core/DataColumnConstraint":27,"./core/DataRelation":28,"./core/DataRow":29,"./core/DataRowCollection":30,"./core/DataRowState":31,"./core/DataRowVersion":32,"./core/DataSet":33,"./core/DataTable":34,"./core/DataView":35,"./core/Util":36}],25:[function(require,module,exports){
"use strict";var SortedArray=require("collections/sorted-array"),util=require("./Util"),DataTable=require("./DataTable"),DataColumn=function(){function t(t,e,r){if(!(t instanceof DataTable))throw new Error("cannot construct DataColumn without DataTable");this._name=e,this._keyPath=r,this._index=new SortedArray(void 0,util.createContentEquator(r),util.createContentComparer(r))}return t.prototype.getValue=function(t){return util.resolveKeyPath(this._keyPath,t)},t.prototype.table=function(){return this._table},t.prototype.name=function(t){return void 0!==t?(this._name=t,this):this._name},t.prototype.keyPath=function(){return void 0===this._keyPath?this.name():this._keyPath},t}(),Item=function(){function t(t,e){this.key=t,this.index=e}return t}();module.exports=DataColumn;
},{"./DataTable":34,"./Util":36,"collections/sorted-array":19}],26:[function(require,module,exports){
...
"use strict";var DataTable=require("./DataTable"),DataRowState=require("./DataRowState"),DataRowVersion=require("./DataRowVersion"),DataRow=function(){function t(t){if(!(t instanceof DataTable))throw new Error("Cannot construct DataRow without DataTable");this._table=t,this._original={},this._current=this._createCurrent(),this._proposed=this._createProposed()}return t.prototype._createCurrent=function(){return Object.create(this._original)},t.prototype._createProposed=function(){if(void 0==this._current)throw new Error("DataRow._current has been deleted");return Object.create(this._current)},t.prototype.get=function(t,e){return this._getItem(t,e)},t.prototype.set=function(t,e,r){return this._setItem(t,e,r)},t.prototype.del=function(t){this._setItem(t,null)},t.prototype.has=function(t){return Object.keys(this._current).indexOf(t)>=0||Object.keys(this._original).indexOf(t)>=0},t.prototype.delete=function(t){this.isEditing()?this._proposed=null:this._current=null},t.prototype.item=function(t,e,r){return void 0!==e?this._setItem(t,e,r):this._getItem(t,r)},t.prototype._getItem=function(t,e){var r=this._getColumn(t);return void 0===r?this._getVersion(e)[t]:r.getValue(this._getVersion(e))},t.prototype._setItem=function(t,e,r){if(this.rowState()==DataRowState.DELETED)throw new Error("Row already deleted");return this._getVersion(r)[t]=e,this},t.prototype._getVersion=function(t){switch(t=t||DataRowVersion.DEFAULT){case DataRowVersion.DEFAULT:return this.isEditing()?this._proposed:this._current;case DataRowVersion.CURRENT:return this._current;case DataRowVersion.ORIGINAL:return this._original;case DataRowVersion.PROPOSED:return this._proposed;default:throw new Error("DataRowVersion {"+t+"} is not recognized")}},t.prototype._getColumn=function(t){return this.table().columns().get(t)},t.prototype.table=function(t){return void 0!==t?(null===t?this._table=void 0:this._table=t,this):this._table},t.prototype.rowState=function(){return null===this._current?DataRowState.DELETED:0===Object.keys(this._current).length?DataRowState.UNCHANGED:void 0===this._table?DataRowState.DETACHED:DataRowState.MODIFIED},t.prototype.beginEdit=function(){if(this.isEditing())throw new Error("already editing");this._proposed=this._createProposed()},t.prototype.isEditing=function(){return!!this._proposed},t.prototype.endEdit=function(){this.dispatchBeforeRowChange();var t=this;Object.keys(this._proposed).forEach(function(e){t._current[e]=t._proposed[e]}),delete this._proposed,this.dispatchRowChange()},t.prototype.acceptChanges=function(){var t=this;Object.keys(this._current).forEach(function(e,r){var o=t._current[e];null===o?delete t._original[e]:t._original[e]=t._current[e]}),this._current=this._createCurrent()},t.prototype.rejectChanges=function(){this._current=this._createCurrent()},t.prototype.dispatchRowChange=function(){},t.prototype.dispatchBeforeRowChange=function(){},t}();module.exports=DataRow;
},{"./DataRowState":31,"./DataRowVersion":32,"./DataTable":34}],30:[function(require,module,exports){
...
},{"collections/sorted-array":19}],31:[function(require,module,exports){
...
"use strict";var DataTable=require("./DataTable"),ds_counter=0,DataSet=function(){function t(t){void 0===t&&(t="Set"+ds_counter++),this._name=t,this._tables=[],this._relations=[]}return t.prototype.tables=function(){return this._tables.slice()},t.prototype.addTable=function(t){var e;e="string"==typeof t?new DataTable(t):t,void 0===e.name()&&e.name("Table"+this._tables.length),this._tables.push(e)},t.prototype.acceptChanges=function(){this._tables.forEach(function(t){t.acceptChanges()})},t.prototype.getChanges=function(){},t.prototype.name=function(t){return void 0!=t&&(this._name=t),this._name},t}();module.exports=DataSet;
},{"./DataTable":34}],34:[function(require,module,exports){
"use strict";var DataColumnCollection=require("./DataColumnCollection"),DataRowCollection=require("./DataRowCollection"),Util_1=require("./Util"),dt_counter=0,DataTable=function(){function t(t,o){this._name=t||"Table"+dt_counter++,this._rows=new DataRowCollection(this),this._columns=new DataColumnCollection(this),this._keyPath=o,this._keyComparer=Util_1.createContentComparer(o)}return t.prototype.name=function(t){return void 0!==t?(this._name=t,this):this._name},t.prototype.rows=function(){return this._rows},t.prototype.columns=function(){return this._columns},t.prototype.keyPath=function(){return this._keyPath},t.prototype.acceptChanges=function(){this._rows.toArray().forEach(function(t){t.acceptChanges()})},t}();console.log("loaded DataTable"),module.exports=DataTable;
},{"./DataColumnCollection":26,"./DataRowCollection":30,"./Util":36}],35:[function(require,module,exports){
"use strict";var DataView=function(){function t(){}return t}();module.exports=DataView;
},{}],36:[function(require,module,exports){
"use strict";function createContentComparer(e){return function(t,r){var n=resolveKeyPath(e,t),o=resolveKeyPath(e,r);return n<o?-1:n>o?1:0}}function createContentEquator(e){return function(t,r){var n=resolveKeyPath(e,t),o=resolveKeyPath(e,r);return n==o}}function compareKeys(e,t){return void 0!==indexedDB?indexedDB.cmp(e,t):e<t?-1:e>t?1:0}function resolveKeyPath(e,t){e=e||"";var r=e.split(".");return r.reduce(function(e,t){if(void 0!==e)return e[t]},t)}function createValueWithKeyPath(e,t){var r=t.split(".");return r.reduceRight(function(e,t,r,n){var o={};return o[t]=e,o},e)}exports.createContentComparer=createContentComparer,exports.createContentEquator=createContentEquator,exports.compareKeys=compareKeys,exports.resolveKeyPath=resolveKeyPath,exports.createValueWithKeyPath=createValueWithKeyPath;
},{}]},{},[24])(24)
});
